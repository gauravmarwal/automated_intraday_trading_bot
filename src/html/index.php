...
<head>
    ...
    <title>Automated Intra-day Trading</title>
    <!-- Custom CSS -->
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span
                                        class="text-dark">Simran</span> <i data-feather="chevron-down"
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <a class="dropdown-item" href="javascript:void(0)"><i data-feather="user"
                                    ...
                                    My Profile</a>
                                <a class="dropdown-item" href="my-balance.php"><i data-feather="credit-card"
                                        class="svg-icon mr-2 ml-1"></i>
                                    My Balance</a>
                                ...
                                <a class="dropdown-item" href="javascript:void(0)"><i data-feather="power"
                                    ...
                                    Logout</a>
                                <div class="dropdown-divider"></div>
                                <div class="pl-4 p-3"><a href="authentication-login1.php" class="btn btn-sm btn-info">View
                                        Profile</a></div>
                            </div>
                        </li>
                        <!-- ============================================================== -->
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span
                                    class="hide-menu">Trading </span></a>
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="my-balance.php" class="sidebar-link"><span
                                            class="hide-menu"> My Wallet
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="..\main_files\templatemo_543_breezed\Trading_screen.php" class="sidebar-link"><span
                                            class="hide-menu"> Trading Screen
                                        </span></a>
                                </li>                         
                            </ul>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Good Morning Simran</h3>
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium"><sup
                                            class="set-rupee">Rs</sup>18,306</h2>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-style-none mb-0">
                                    <li>
                                        ...
                                        <span class="text-dark float-right font-weight-medium">Rs2346</span>
                                    </li>
                                    <li class="mt-3">
                                        <i class="fas fa-circle text-danger font-10 mr-2"></i>
                                        <span class="text-muted">Referral Sales</span>
                                        <span class="text-dark float-right font-weight-medium">Rs2108</span>
                                    </li>
                                    <li class="mt-3">
                                        <i class="fas fa-circle text-cyan font-10 mr-2"></i>
                                        <span class="text-muted">Affiliate Sales</span>
                                        <span class="text-dark float-right font-weight-medium">Rs1204</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <table class="table no-wrap v-middle mb-0">
                                        ...
                                        <tbody>
                                                ...
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="text-muted font-14">simran@gmail.com</span>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="text-muted font-14">nilesh@gmail.com</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="font-weight-medium text-dark px-2 py-4">Rs80K</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
