...
def convert(amount): 
	''' converts USD to INR ''' 
	return c.convert(amount, 'USD', 'INR')
...
print(f"Future high after {LOOKUP_STEP} days is {future_high:.2f}")
print(f"Future high in dollars, after {LOOKUP_STEP} days is {future_high_in_dollars:.2f}")
print(f"Future low after {LOOKUP_STEP} days is {future_low:.2f}")
